...
//   xhr.open("GET", "https://staging.yoga.saankhyalabs.com/feapi/frontend/devices/B0:7E:11:4A:0F:E8/stats/");
//   xhr.setRequestHeader("Authorization", "Basic YnJob3duZXI6MTIzQEJyaG93bmVy");
//   xhr.setRequestHeader("Content-Type", "application/json");
  
//   xhr.send(data);
xhr.open("GET", "http://174.138.120.85:3008/7");
xhr.send(); 
        ...
        <pre></pre>
          <Card style={{}}>
            ...
            <CardBody>
              ...
              <a href="https://www.google.com/maps/place/Shangri+Las+Eros+Hotel,+19,+Ashoka+Rd,+Janpath,+Connaught+Place,+New+Delhi,+Delhi+110001/@28.62092,77.2160513,17z/" target="_blank" rel="noopener noreferrer">Location Map</a>
