...
//   xhr.open("GET", "https://staging.yoga.saankhyalabs.com/feapi/frontend/devices/B0:7E:11:04:A2:00/stats/");
//   xhr.setRequestHeader("Authorization", "Basic YnJob3duZXI6MTIzQEJyaG93bmVy");
//   xhr.setRequestHeader("Content-Type", "application/json");
  
//   xhr.send(data);
xhr.open("GET", "http://174.138.120.85:3008/3");
xhr.send(); 
        ...
        <pre></pre>
          <Card style={{}}>
            ...
            <CardBody>
              ...
              <a href="https://maps.google.com/?q=28.62092,77.21824" target="_blank" rel="noopener noreferrer">Location Map</a>
